...
int main()
{
    ...
    switch (choice) {
        ...
        default:
            ...
            main(); // Recursively call main to show the menu again
    }
    return 0;
}
...
void account(void)
{
    ...
    u2.password[i] = '\0'; // Null terminate the password
    ...
    if (strcmp(u2.password, confirm_password) == 0) {
    ...
    if (password_matched) {
        ...
        printf("\nAccount creation failed. Passwords do not match.\n");
    }
}
...
void login(void)
{
    ...
    // Checking if username and password exists in the file or not
...
void display(char username1[])
{
    ...
    while (fread(&u1, sizeof(u1), 1, fp)) {
        if (strcmp(username1, u1.username) == 0) {
            ...
            gotoxy(55, 16);
            printf("AADHAR CARD NUMBER..%s", u1.adharnum);
            gotoxy(55, 18);
    ...
    switch (choice) {
        ...
        default:
            printf("Invalid choice! Please try again.");
            display(username1); // Recursively call display to show the menu again
    }
}
